...
const defaultConfigValues: DefaultConfigValues = {
  ...
  Struct: {
    children: [
      { name: "name", dataType: "Utf8", nullable: false, id: 1n },
      { name: "age", dataType: "Int8", nullable: false, id: 2n },
    ],
  },
  // Dictionary: {
  //   dictionary: {
  ...
  //   typeIds: [1, 2],
  //   children: [
  //     { name: "str", dataType: "Utf8", nullable: false, id: 1n },
  //     { name: "num", dataType: "Int8", nullable: false, id: 2n },
  //   ],
  // },
  // DenseUnion: {
  //   typeIds: [1, 2],
