...
export type CodecType<C extends Codec> = Prettify<ReturnType<C["decode"]>>;

/* Helper to get the protobuf type of a codec */
export type CodecProto<C extends Codec> = Prettify<ReturnType<C["encode"]>>;
...
export type ArrayCodec<T extends Codec> =
...
export type RequiredCodec<T extends Codec> =
  T extends Codec<infer TApp, infer TProto>
